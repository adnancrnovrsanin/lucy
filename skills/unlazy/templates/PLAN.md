...
Scope: <validated pipeline id; store this file at .lucy/gates/<scope>/PLAN.md>
Depth: tree <N>
Mode: orchestrated
...
Append events to `.lucy/gates/<scope>/status.log`; do not copy the event history into this file:
