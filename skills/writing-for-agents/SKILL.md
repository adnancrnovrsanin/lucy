...
description: "Use when dispatching a subagent or writing its brief, creating or editing a skill, or editing AGENTS.md or CLAUDE.md: how to write a document an agent will act on."
---
...
A dispatch prompt is a document for an agent. Hand it pointers (a brief file, a report path, the spec) rather than pasted context, state its completion criterion and report contract, and keep the session's history out of it.
