...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Structure:**
    ...
    would block a merge over, such as verbatim duplication of a logic block,
    swallowed errors, or tests that assert nothing. "Coverage could be broader"
    ...
    - Cannot verify from diff: [requirements you could not verify from the
      ...
      compliant-or-issues verdict for everything you could verify]
...
**Placeholders:**
- `[MODEL]`: required, the reviewer model per SKILL.md model selection
...
**Reviewer returns:** Spec compliance verdict (compliant, issues found, or
cannot verify from diff), Strengths, Issues (Critical/Important/Minor), Task
quality verdict
